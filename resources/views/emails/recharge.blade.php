                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/0cadaae1b677ac715ccc000e1/images/b51412df-9284-4484-8b17-aaab8b5c1529.png" width="281" style="max-width:281px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h3 style="text-align: center;">Detalles de Recarga</h3>

<p>Estimado <strong>{{$user}}</strong>, te agradecemos por realizar tu recarga por medio del servicio <strong>{{$service}}.</strong><br>
<br>
A continuación te mostramos el detalle de tu recarga y el balance general de tu cuenta:</p>
<table style="margin: 20px auto;">
    <tbody>
        <tr>
            <td>Total de recarga:</td>
            <td style="text-align:right;"><b>${{number_format($total,2)}}</b></td>
        </tr>
        <tr>
            <td>Comisión de servicio:</td>
            <td style="text-align:right;"><b>${{number_format($comision,2)}}</b></td>
        </tr>
        <tr>
            <td>Total recargado:</td>
            <td style="text-align:right;"><b>${{number_format(($total - $comision),2)}}</b></td>
        </tr>
        <tr>
            <td>Saldo total:</td>
...
<div style="text-align: center;">Si tienes&nbsp; algun inconveniente con la recarga realizada, favor de contactar&nbsp;inmediatamente al equipo de sorporte.</div>
