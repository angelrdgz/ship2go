                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <p>Sentimos mucho que hayas olvidado tu contraseña, pero no te preocupes, te compartimos un link que puedes usar para crear una contraseña nueva.<br>
<br>
Da click en el siguiente boton y regalanos tu nueva contraseña para seguir disfrutando de los beneficios que ship2go tiene para ti.</p>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                <a class="mcnButton " title="Nueva Contraseña" href="{{$link}}" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Nueva Contraseña</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
